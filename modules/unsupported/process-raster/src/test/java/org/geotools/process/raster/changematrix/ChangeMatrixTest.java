...
public void testMultipleBands() {
    ...
    BufferedImage reference = new BufferedImage(800, 600,
            BufferedImage.TYPE_3BYTE_BGR);
    RenderedOp now = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Byte[] { Byte.valueOf((byte) 0) }, null);
    ...
    try {
        result.getWidth();
        assertTrue(
                "we should have got an exception as the image types have multiple bands!",
                false);
    } catch (Exception e) {
...
public void testDifferentTypes() {
    ...
    RenderedOp reference = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Integer[] { Integer.valueOf(1) }, null);
    RenderedOp now = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Byte[] { Byte.valueOf((byte) 0) }, null);
    final ParameterBlockJAI pbj = new ParameterBlockJAI("ChangeMatrix");
    pbj.addSource(reference);
    ...
    try {
        result.getWidth();
        assertTrue(
                "we should have got an exception as the image types are different!",
                false);
    } catch (Exception e) {
        // fine we get an exception
    }
...
public void testDifferentDimensions() {
    ...
    RenderedOp reference = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Integer[] { Integer.valueOf(1) }, null);
    RenderedOp now = ConstantDescriptor.create(Float.valueOf(700),
            Float.valueOf(600), new Integer[] { Integer.valueOf(0) }, null);
    final ParameterBlockJAI pbj = new ParameterBlockJAI("ChangeMatrix");
    pbj.addSource(reference);
    pbj.addSource(now);
    pbj.setParameter("result", cm);
    ...
    try {
        result.getWidth();
        assertTrue(
                "we should have got an eception as the image types are different!",
                false);
    } catch (Exception e) {
        // fine we get an exception
    }
...
public void testFloatTypes() {
    ...
    RenderedOp reference = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Float[] { Float.valueOf(1.0f) }, null);
    RenderedOp now = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Float[] { Float.valueOf(0.0f) }, null);
    final ParameterBlockJAI pbj = new ParameterBlockJAI("ChangeMatrix");
    pbj.addSource(reference);
    pbj.addSource(now);
    pbj.setParameter("result", cm);
    ...
    try {
        result.getWidth();
        assertTrue(
                "we should have got an eception as the image types are Float!",
                false);
    } catch (Exception e) {
        // fine we get an exception
    }
...
public void testDoubleTypes() {
    ...
    RenderedOp reference = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Double[] { Double.valueOf(1.0) }, null);
    RenderedOp now = ConstantDescriptor.create(Float.valueOf(800),
            Float.valueOf(600), new Double[] { Double.valueOf(0.0) }, null);
    final ParameterBlockJAI pbj = new ParameterBlockJAI("ChangeMatrix");
    pbj.addSource(reference);
    pbj.addSource(now);
    pbj.setParameter("result", cm);
    ...
    try {
        result.getWidth();
        assertTrue(
                "we should have got an eception as the image types are Double!",
                false);
    } catch (Exception e) {
        // fine we get an exception
    }
...
public void completeTestShortDatatype() throws Exception {
    ...
    final RenderedOp source = JAI.create("ImageRead",
            TestData.file(this, "clc2006_L3_100m_small_short.tif"));// new
    // File("d:/data/unina/clc2006_L3_100m.tif"));
    final RenderedOp reference = JAI.create("ImageRead",
            TestData.file(this, "clc2000_L3_100m_small_short.tif"));// new
    // File("d:/data/unina/clc2000_L3_100m.tif"));
...
public void completeTestIntDatatype() throws Exception {
    ...
    final RenderedOp source = JAI.create("ImageRead",
            TestData.file(this, "clc2006_L3_100m_smaller_int.tif"));// new
    // File("d:/data/unina/clc2006_L3_100m.tif"));
    final RenderedOp reference = JAI.create("ImageRead",
            TestData.file(this, "clc2000_L3_100m_smaller_int.tif"));// new
    // File("d:/data/unina/clc2000_L3_100m.tif"));
